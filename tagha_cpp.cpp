...
uint32_t TaghaScriptCPP::memsize()
{
	return TaghaScript_memsize(this->script);
}
...
int32_t TaghaVMCPP::call_script_func(const char *strFunc)
{
	return Tagha_call_script_func(this->vm, strFunc);
}
