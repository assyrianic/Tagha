#!/bin/bash
cd "$(dirname "$0")"
clang-3.5	-std=c11 -O3 -fPIC -c ds.c taghavm_api.c taghascript_api.c tagha_exec.c tagha_libc.c
...
gcc			-std=c11 -O3 -fPIC -c ds.c taghavm_api.c taghascript_api.c tagha_exec.c tagha_libc.c
