#!/bin/bash
cd "$(dirname "$0")"
clang-3.5	-std=c11 -Os -fPIC -c vector.c hashmap.c taghaapi.c tagha.c tagha_libc.c
...
gcc			-std=c11 -Os -fPIC -c vector.c hashmap.c taghaapi.c tagha.c tagha_libc.c
