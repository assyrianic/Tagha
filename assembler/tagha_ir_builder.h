...
static inline struct TaghaIR tagha_ir_push_imm(const uint64_t val)
{
	return (struct TaghaIR){ .ir.imm.val=val, .ir.imm.r = -1, TIR_PUSH_IMM };
}
...
{
	return (struct TaghaIR){ .ir.mem.offset = offset, .ir.mem.regs = { r, rbp }, TIR_LOADBP };
}
	...
	for( struct TaghaIRBlock *b = harbol_vector_get_iter(&tfn->blocks); b != NULL && b < bbend; b++ ) {
		...
		for( const struct TaghaIR *i = harbol_vector_get_iter(&b->ir); i != NULL && i < irend; i++ ) {
			switch( i->op ) {
				...
				case TIR_NE: prog_counter += tagha_bc_op_reg_reg(NULL, neq, i->ir.regs[0], i->ir.regs[1]); break;
				...
				case TIR_GE: prog_counter += tagha_bc_op_reg_reg(NULL, (i->usign) ? uge: ige, i->ir.regs[0], i->ir.regs[1]); break;
				case TIR_GT: prog_counter += tagha_bc_op_reg_reg(NULL, (i->usign) ? ugt: igt, i->ir.regs[0], i->ir.regs[1]); break;
...
#			ifdef TAGHA_USE_FLOATS
				...
				case TIR_FEQ: prog_counter += tagha_bc_op_reg_reg(NULL, cmpf, i->ir.regs[0], i->ir.regs[1]); break;
				case TIR_FNE: prog_counter += tagha_bc_op_reg_reg(NULL, neqf, i->ir.regs[0], i->ir.regs[1]); break;
				...
				case TIR_FGE: prog_counter += tagha_bc_op_reg_reg(NULL, gef, i->ir.regs[0], i->ir.regs[1]); break;
				case TIR_FGT: prog_counter += tagha_bc_op_reg_reg(NULL, gtf, i->ir.regs[0], i->ir.regs[1]); break;
#			endif
				...
				case TIR_INCR: prog_counter += tagha_bc_op_reg(NULL, inc, i->ir.regs[0]); break;
				case TIR_DECR: prog_counter += tagha_bc_op_reg(NULL, dec, i->ir.regs[0]); break;
				case TIR_PUSH: prog_counter += tagha_bc_op_reg(NULL, push, i->ir.regs[0]); break;
				
#			ifdef TAGHA_USE_FLOATS
				case TIR_F32_TO_F64: prog_counter += tagha_bc_op_reg(NULL, flt2dbl, i->ir.regs[0]); break;
				case TIR_F64_TO_F32: prog_counter += tagha_bc_op_reg(NULL, dbl2flt, i->ir.regs[0]); break;
				case TIR_INT_TO_F32: prog_counter += tagha_bc_op_reg(NULL, int2flt, i->ir.regs[0]); break;
				case TIR_INT_TO_F64: prog_counter += tagha_bc_op_reg(NULL, int2dbl, i->ir.regs[0]); break;
				case TIR_FINCR: prog_counter += tagha_bc_op_reg(NULL, incf, i->ir.regs[0]); break;
				case TIR_FDECR: prog_counter += tagha_bc_op_reg(NULL, decf, i->ir.regs[0]); break;
...
#			endif
				...
				case TIR_LOADBP: prog_counter += tagha_bc_op_reg_mem(NULL, loadaddr, i->ir.mem.regs[0], i->ir.mem.regs[1], i->ir.mem.offset); break;
				...
				// reg <-- imm type instrs.
				case TIR_LOADFN: prog_counter += tagha_bc_op_reg_imm(NULL, loadfunc, i->ir.imm.r, i->ir.imm.val); break;
				case TIR_LOADVAR: prog_counter += tagha_bc_op_reg_imm(NULL, loadglobal, i->ir.imm.r, i->ir.imm.val); break;
				case TIR_MOV_IMM: prog_counter += tagha_bc_op_reg_imm(NULL, movi, i->ir.imm.r, i->ir.imm.val); break;
				
				// imm only instrs.
				case TIR_PUSH_IMM: prog_counter += tagha_bc_op_imm(NULL, pushi, i->ir.imm.val); break;
	...
	for( const struct TaghaIRBlock *b = harbol_vector_get_iter(&tfn->blocks); b != NULL && b < bbend; b++ ) {
		...
		for( const struct TaghaIR *i = harbol_vector_get_iter(&b->ir); i != NULL && i < irend; i++ ) {
			switch( i->op ) {
				...
				case TIR_NE: prog_counter += tagha_bc_op_reg_reg(&bytecode, neq, i->ir.regs[0], i->ir.regs[1]); break;
				...
				case TIR_GE: prog_counter += tagha_bc_op_reg_reg(&bytecode, (i->usign) ? uge: ige, i->ir.regs[0], i->ir.regs[1]); break;
				case TIR_GT: prog_counter += tagha_bc_op_reg_reg(&bytecode, (i->usign) ? ugt: igt, i->ir.regs[0], i->ir.regs[1]); break;
...
#			ifdef TAGHA_USE_FLOATS
				...
				case TIR_FEQ: prog_counter += tagha_bc_op_reg_reg(&bytecode, cmpf, i->ir.regs[0], i->ir.regs[1]); break;
				case TIR_FNE: prog_counter += tagha_bc_op_reg_reg(&bytecode, neqf, i->ir.regs[0], i->ir.regs[1]); break;
				...
				case TIR_FGE: prog_counter += tagha_bc_op_reg_reg(&bytecode, gef, i->ir.regs[0], i->ir.regs[1]); break;
				case TIR_FGT: prog_counter += tagha_bc_op_reg_reg(&bytecode, gtf, i->ir.regs[0], i->ir.regs[1]); break;
#			endif
				...
				case TIR_INCR: prog_counter += tagha_bc_op_reg(&bytecode, inc, i->ir.regs[0]); break;
				case TIR_DECR: prog_counter += tagha_bc_op_reg(&bytecode, dec, i->ir.regs[0]); break;
				case TIR_PUSH: prog_counter += tagha_bc_op_reg(&bytecode, push, i->ir.regs[0]); break;
				
#			ifdef TAGHA_USE_FLOATS
				case TIR_F32_TO_F64: prog_counter += tagha_bc_op_reg(&bytecode, flt2dbl, i->ir.regs[0]); break;
				case TIR_F64_TO_F32: prog_counter += tagha_bc_op_reg(&bytecode, dbl2flt, i->ir.regs[0]); break;
				case TIR_INT_TO_F32: prog_counter += tagha_bc_op_reg(&bytecode, int2flt, i->ir.regs[0]); break;
				case TIR_INT_TO_F64: prog_counter += tagha_bc_op_reg(&bytecode, int2dbl, i->ir.regs[0]); break;
				case TIR_FINCR: prog_counter += tagha_bc_op_reg(&bytecode, incf, i->ir.regs[0]); break;
				case TIR_FDECR: prog_counter += tagha_bc_op_reg(&bytecode, decf, i->ir.regs[0]); break;
...
#			endif
				...
				case TIR_LOADBP: prog_counter += tagha_bc_op_reg_mem(&bytecode, loadaddr, i->ir.mem.regs[0], i->ir.mem.regs[1], i->ir.mem.offset); break;
				...
				// reg <-- imm type instrs.
				case TIR_LOADFN: prog_counter += tagha_bc_op_reg_imm(&bytecode, loadfunc, i->ir.imm.r, i->ir.imm.val); break;
				case TIR_LOADVAR: prog_counter += tagha_bc_op_reg_imm(&bytecode, loadglobal, i->ir.imm.r, i->ir.imm.val); break;
				case TIR_MOV_IMM: prog_counter += tagha_bc_op_reg_imm(&bytecode, movi, i->ir.imm.r, i->ir.imm.val); break;
				
				// imm only instrs.
				case TIR_PUSH_IMM: prog_counter += tagha_bc_op_imm(&bytecode, pushi, i->ir.imm.val); break;
...
#undef X
#define Y(y) #y ,
	const char *regs2str[] = { TAGHA_REGISTER_FILE };
	regs2str[rsp] = "sp";
	regs2str[rbp] = "bp";
	regs2str[instr] = NULL;
#undef Y
	...
	for( const struct TaghaIRBlock *b = harbol_vector_get_iter(&tfn->blocks); b != NULL && b < bbend; b++ ) {
		...
		for( const struct TaghaIR *i = harbol_vector_get_iter(&b->ir); i != NULL && i < irend; i++ ) {
			switch( i->op ) {
				...
				case TIR_NE:
					harbol_string_add_format(&str, "    %s        r%s, r%s\n", opcode2str[neq], regs2str[i->ir.regs[0]], regs2str[i->ir.regs[1]]); break;
				case TIR_LE:
				...
				case TIR_GE:
					harbol_string_add_format(&str, "    %s        r%s, r%s\n", opcode2str[(i->usign) ? uge : ige], regs2str[i->ir.regs[0]], regs2str[i->ir.regs[1]]); break;
				case TIR_GT:
					harbol_string_add_format(&str, "    %s        r%s, r%s\n", opcode2str[(i->usign) ? ugt : igt], regs2str[i->ir.regs[0]], regs2str[i->ir.regs[1]]); break;
...
#			ifdef TAGHA_USE_FLOATS
				...
				case TIR_FEQ:
					harbol_string_add_format(&str, "    %s       r%s, r%s\n", opcode2str[cmpf], regs2str[i->ir.regs[0]], regs2str[i->ir.regs[1]]); break;
				case TIR_FNE:
					harbol_string_add_format(&str, "    %s       r%s, r%s\n", opcode2str[neqf], regs2str[i->ir.regs[0]], regs2str[i->ir.regs[1]]); break;
				case TIR_FLE:
				...
				case TIR_FGE:
					harbol_string_add_format(&str, "    %s        r%s, r%s\n", opcode2str[gef], regs2str[i->ir.regs[0]], regs2str[i->ir.regs[1]]); break;
				case TIR_FGT:
					harbol_string_add_format(&str, "    %s        r%s, r%s\n", opcode2str[gtf], regs2str[i->ir.regs[0]], regs2str[i->ir.regs[1]]); break;
#			endif
				...
				case TIR_INCR:
					harbol_string_add_format(&str, "    %s        r%s\n", opcode2str[inc], regs2str[i->ir.regs[0]]); break;
				case TIR_DECR:
					harbol_string_add_format(&str, "    %s        r%s\n", opcode2str[dec], regs2str[i->ir.regs[0]]); break;
				case TIR_PUSH:
					harbol_string_add_format(&str, "    %s       r%s\n", opcode2str[push], regs2str[i->ir.regs[0]]); break;
				
#			ifdef TAGHA_USE_FLOATS
				case TIR_F32_TO_F64:
					harbol_string_add_format(&str, "    %s r%s\n", opcode2str[flt2dbl], regs2str[i->ir.regs[0]]); break;
				case TIR_F64_TO_F32:
					harbol_string_add_format(&str, "    %s r%s\n", opcode2str[dbl2flt], regs2str[i->ir.regs[0]]); break;
				case TIR_INT_TO_F32:
					harbol_string_add_format(&str, "    %s r%s\n", opcode2str[int2flt], regs2str[i->ir.regs[0]]); break;
				case TIR_INT_TO_F64:
					harbol_string_add_format(&str, "    %s r%s\n", opcode2str[int2dbl], regs2str[i->ir.regs[0]]); break;
				case TIR_FINCR:
					harbol_string_add_format(&str, "    %s       r%s\n", opcode2str[incf], regs2str[i->ir.regs[0]]); break;
				case TIR_FDECR:
					harbol_string_add_format(&str, "    %s       r%s\n", opcode2str[decf], regs2str[i->ir.regs[0]]); break;
				case TIR_FNEG:
...
#			endif
				...
				case TIR_LOADBP:
					harbol_string_add_format(&str, "    %s r%s, [r%s + %i]\n", opcode2str[loadaddr], regs2str[i->ir.mem.regs[0]], regs2str[i->ir.mem.regs[1]], i->ir.mem.offset); break;
				...
				// reg <-- imm type instrs.
				case TIR_LOADFN:
					harbol_string_add_format(&str, "    %s r%s, %%F%" PRIu64 "\n", opcode2str[loadfunc], regs2str[i->ir.imm.r], i->ir.imm.val); break;
				case TIR_LOADVAR:
					harbol_string_add_format(&str, "    %s r%s, %%V%" PRIu64 "\n", opcode2str[loadglobal], regs2str[i->ir.imm.r], i->ir.imm.val); break;
				case TIR_MOV_IMM:
					harbol_string_add_format(&str, "    %s       r%s, %" PRIu64 "\n", opcode2str[movi], regs2str[i->ir.imm.r], i->ir.imm.val); break;
				
				// imm only instrs.
				case TIR_PUSH_IMM:
					harbol_string_add_format(&str, "    %s      %" PRIu64 "\n", opcode2str[pushi], i->ir.imm.val); break;
