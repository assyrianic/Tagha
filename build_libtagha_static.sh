#!/bin/bash
cd "$(dirname "$0")"
gcc			-Wextra -Wall -std=c99 -O3 -funroll-loops -finline-functions -ffast-math -fexpensive-optimizations -c	tagha_api.c #-fno-guess-branch-probability -fomit-frame-pointer
